...
public class MealView {
    ...
    public StackPane build(MealController ctrl, String mealType) {
        ...
        for (int i = 0; i < existing.size(); i++) {
            ...
            dishBtn.setStyle("-fx-background-color: #4CAF50; " +
                    "-fx-text-fill: black; " +
                    "-fx-font-size: 14px; " +
        ...
        addDishBtn.setStyle("-fx-background-color: #A9A9A9; " +
                "-fx-text-fill: black; " +
                "-fx-font-size: 14px; " +
                "-fx-border-radius: 8;");
        if (existing.size() >= MAX_DISHES) addDishBtn.setDisable(true);
        ...
        addDishBtn.setOnAction(e -> {
            ...
            if (currentSize < MAX_DISHES) {
                ...
                dishBtn.setStyle("-fx-background-color: #A9A9A9; " +
                        "-fx-text-fill: black; " +
                        "-fx-font-size: 14px; " +
                        "-fx-background-radius: 8;");
            ...
            if (dishButtons.getChildren().size() >= MAX_DISHES) addDishBtn.setDisable(true);
        });
